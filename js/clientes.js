        ...
        data.forEach(element => {
            ...
            <td>${element.cedula}</td>
             ...
             <td>${element.telefono}</td>
              ...
              <td>
              <button type="button" class="botoncito" onclick='window.location="/form_clientes.html?id=${element._id}"'><img src="/css/imagenes/edi.png" alt="Descripción de la imagen" class="ico"></button>
              <button type="button" class="botoncito-e" onclick="EliminarClientes('${element._id}')"><img src="/css/imagenes/eli.png" alt="Descripción de la imagen" class="ico"></button>
              </td>
