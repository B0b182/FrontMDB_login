        ...
        data.forEach(element => {
            ...
            <td>${element.proveedor}</td>
             ...
             <td>${element.ingreso}</td>
              <td>
              <button type="button" class="botoncito" onclick='window.location="/form_producto.html?id=${element._id}"'><img src="/css/imagenes/edi.png" alt="Descripción de la imagen" class="ico"></button>
              <button type="button" class="botoncito-e" onclick="Eliminarproducto('${element._id}')"><img src="/css/imagenes/eli.png" alt="Descripción de la imagen" class="ico"></button>
              </td>
